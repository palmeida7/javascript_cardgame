...
document.getElementById("header name").innerText = "Hi Lo There!";


let stratName = document.getElementById("stratname");
document.getElementById("stratname").innerText = "Recommendation: ";

const strText = headerName.textContent;
const splitText = strText.split("");
headerName.textContent = "";
for(let i=0; i < splitText.length; i++){
    headerName.innerHTML += "<span>" + splitText[i] + "</span>";
}
...
function onTick() {
    const span = headerName.querySelectorAll('span')[char];
